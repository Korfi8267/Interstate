...
<nav class="bg-gray-100 dark:bg-slate-800 shadow-md sticky top-0">
  <div class="max-w-7xl mx-auto px-2">
    <div class="justify-left items-center p-5 gap-8 flex flex-row">
      ...
      <a href=".App2.vue/" class="hidden sm:block transition ease-in-out delay-50 hover:scale-105 font-semibold text-blue-600 dark:text-blue-400">Home</a>
      <a href="#" class="hidden sm:block transition ease-in-out delay-50 hover:scale-105 font-medium text-slate-500 hover:text-gray-900 dark:hover:text-blue-200">Portfolio</a>
      <a href="#" class="hidden sm:block transition ease-in-out delay-50 hover:scale-105 font-medium text-slate-500 hover:text-gray-900 dark:hover:text-blue-200">Packages</a>
    </div>
  </div>
</nav>
...
<div class="text-center">
  ...
  <div class="my-4"></div>
  <span class="text-xl font-medium text-black dark:text-white">I'm a designer and photographer at heart.</span>
</div><br/>
