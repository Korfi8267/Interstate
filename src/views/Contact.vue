...
<div class="flex justify-center items-center flex-wrap space-x-2">
  <div class="flex justify-center gap-6">
    <a href="https://discord.gg/WXcdtQK" type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" class="px-6 py-2.5 mb-2 transition ease-in-out delay-50 hover:scale-105 rounded-md hover:shadow-lg text-black dark:text-white hover:text-blue-400 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 items-center flex">
  ...
  Discord
    ...
    <a href="https://github.com/Korfi8267" type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" class="px-6 py-2.5 mb-2 transition ease-in-out delay-50 hover:scale-105 rounded-md hover:shadow-lg text-black dark:text-white hover:text-slate-700 dark:hover:text-slate-400 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 items-center flex">
  ...
  Github
    ...
    <a href="https://twitter.com/Korfi8267" type="button" class="px-6 py-2.5 mb-2 transition ease-in-out delay-50 hover:scale-105 rounded-md hover:shadow-lg text-black dark:text-white hover:text-blue-500 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 items-center flex">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 mr-2">
