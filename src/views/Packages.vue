...
<div class="flex flex-col md:flex-row items-center text-center md:text-left justify-center px-7 md:px-20">
    ...
    <div class="text-3xl font-semibold text-black dark:text-white">My Packages.<div class="text-xl font-normal text-gray-600 dark:text-gray-300">Items that are available for download.</div></div>
    <div class="py-4 md:py-0"></div><div class="flex grow max-w-[824px]"></div>
  </div>
